...
%
    ...
    for r = 1:numel(rows)
        ...
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(node7.outputPort, sort_node.inputPorts(1,:), options.connectionColor);
        ...
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(node3.outputPort, stim_resp_node.inputPorts(1,:), options.connectionColor);
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(sort_node.outputPort, stim_resp_node.inputPorts(2,:), options.connectionColor);
        ...
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(stim_resp_node.outputPort, fit_node.inputPorts(1,:), options.connectionColor);
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(sort_node.outputPort, fit_node.inputPorts(2,:), options.connectionColor);
        ...
        ndi.calc.paperFigures.triangleNode.plot_hvh_line(fit_node.outputPort, plot_node.inputPorts(1,:), options.connectionColor);
    end
