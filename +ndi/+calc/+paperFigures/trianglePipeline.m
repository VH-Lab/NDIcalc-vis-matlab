...
%
    ...
    ndi.calc.paperFigures.triangleNode.plot_hvh_line(stim_resp_node_1.outputPort, fit_node_1.inputPorts(2,:), options.connectionColor);
    ...
    ndi.calc.paperFigures.triangleNode.plot_hvh_line(stim_resp_node_2.outputPort, fit_node_2.inputPorts(2,:), options.connectionColor);
