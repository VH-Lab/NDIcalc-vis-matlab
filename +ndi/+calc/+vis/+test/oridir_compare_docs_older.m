...
dbpo_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(1),doc_a.fit.double_gaussian_parameters(1));
if dbpo_match 
   dbpo_match = max(abs(doc_e.fit.double_gaussian_parameters(1) - doc_a.fit.double_gaussian_parameters(1))) < dgpon;
end
...
dbpt_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(2),doc_a.fit.double_gaussian_parameters(2));
if dbpt_match 
   dbpt_match = max(abs(doc_e.fit.double_gaussian_parameters(2) - doc_a.fit.double_gaussian_parameters(2))) < dgpon;
end
...
dbpt_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(3),doc_a.fit.double_gaussian_parameters(3));
if dbpt_match 
   dbpt_match = max(abs(doc_e.fit.double_gaussian_parameters(3) - doc_a.fit.double_gaussian_parameters(3))) < dbptf;
end
...
dbpf_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(4),doc_a.fit.double_gaussian_parameters(4));
if dbpf_match 
   dbpf_match = max(abs(doc_e.fit.double_gaussian_parameters(4) - doc_a.fit.double_gaussian_parameters(4))) < dgpf_pref;
end
...
dbpfi_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(5),doc_a.fit.double_gaussian_parameters(5));
if dbpfi_match 
   dbpfi_match = max(abs(doc_e.fit.double_gaussian_parameters(5) - doc_a.fit.double_gaussian_parameters(5))) < dbpfi;
end
...
dgfa_match = vlt.data.sizeeq(doc_e.fit.double_gaussian_parameters(:),doc_a.fit.double_gaussian_parameters(:));
if dgfa_match
   dgfa_match = 1;
end
...
if any(abs(doc_e.fit.double_gaussian_parameters(:) - doc_a.fit.double_gaussian_parameters(:)) > 5)
   b = 0;
