...
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(1), doc_a.fit_dog.parameters(1), tol_fit_dog.parameters(1), 'fit_dog parameter 1');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(2), doc_a.fit_dog.parameters(2), tol_fit_dog.parameters(2), 'fit_dog parameter 2');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(3), doc_a.fit_dog.parameters(3), tol_fit_dog.parameters(3), 'fit_dog parameter 3');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(4), doc_a.fit_dog.parameters(4), tol_fit_dog.parameters(4), 'fit_dog parameter 4');
...
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(1), doc_a.fit_dog.parameters(1), tol_fit_gausslog.parameters(1), 'fit_gausslog parameter 1');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(2), doc_a.fit_dog.parameters(2), tol_fit_gausslog.parameters(2), 'fit_gausslog parameter 2');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(3), doc_a.fit_dog.parameters(3), tol_fit_gausslog.parameters(3), 'fit_gausslog parameter 3');
[b_(end+1),errormsg_{end+1}] = ndi.test.values_within_tolerance(doc_e.fit_dog.parameters(4), doc_a.fit_dog.parameters(4), tol_fit_gausslog.parameters(4), 'fit_gausslog parameter 4');
