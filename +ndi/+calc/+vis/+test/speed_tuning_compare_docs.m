...
switch(scope),
    case 'standard',
       ...
       tolerance.fit.Priebe_fit_parameters = 1e-6;
...
[b_(11),errormsg_{11}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_parameters, doc_a.fit.Priebe_fit_parameters, tolerance.fit.Priebe_fit_parameters, 'Priebe fit parameters');
[b_(12),errormsg_{12}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_spatial_frequencies, doc_a.fit.Priebe_fit_spatial_frequencies, tolerance.fit.Priebe_fit_spatial_frequencies, 'Priebe fit spatial frequencies');
[b_(13),errormsg_{13}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_temporal_frequencies, doc_a.fit.Priebe_fit_temporal_frequencies, tolerance.fit.Priebe_fit_temporal_frequencies, 'Priebe fit temporal frequencies');
[b_(14),errormsg_{14}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_values, doc_a.fit.Priebe_fit_values, tolerance.fit.Priebe_fit_values, 'Priebe fit values');
[b_(15),errormsg_{15}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_speed_tuning_index, doc_a.fit.Priebe_fit_speed_tuning_index, tolerance.fit.Priebe_fit_speed_tuning_index, 'Priebe fit speed tuning index');
[b_(16),errormsg_{16}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_spatial_frequency_preference, doc_a.fit.Priebe_fit_spatial_frequency_preference, tolerance.fit.Priebe_fit_spatial_frequency_preference, 'Priebe fit spatial frequency preference');
[b_(17),errormsg_{17}] = ndi.test.values_within_tolerance(doc_e.fit.Priebe_fit_temporal_frequency_preference, doc_a.fit.Priebe_fit_temporal_frequency_preference, tolerance.fit.Priebe_fit_temporal_frequency_preference, 'Priebe fit temporal frequency preference');
