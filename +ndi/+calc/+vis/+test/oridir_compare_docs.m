...
switch(scope),
    case 'standard',
       ...
       tolerance.tuning_curve.visual_response_anova_p = 0.1;
       tolerance.tuning_curve.across_stimuli_anova_p = 0.1;
       tolerance.tuning_curve.stddev = 1e-6;
       tolerance.tuning_curve.stddev = 1e-6;
       tolerance.tuning_curve.stddev = 1e-6;
       tolerance.tuning_curve.stddev = 1e-6;
...
[b_(8),errormsg_{8}] = ndi.test.values_within_tolerance(doc_e.significance.visual_response_anova_p, doc_a.significance.visual_response_anova_p, tolerance.tuning_curve.visual_response_anova_p, 'visual response anova p');
[b_(9),errormsg_{9}] = ndi.test.values_within_tolerance(doc_e.significance.across_stimuli_anova_p, doc_a.significance.across_stimuli_anova_p, tuning_curve.across_stimuli_anova_p, 'across stimli anova p');
...
[b_(17),errormsg_{17}] = ndi.test.values_within_tolerance(doc_e.fit.double_gaussian_parameters(1), doc_a.fit.double_gaussian_parameters(1), 5, 'double gaussian parameters #1');
[b_(18),errormsg_{18}] = ndi.test.values_within_tolerance(doc_e.fit.double_gaussian_parameters(2), doc_a.fit.double_gaussian_parameters(2), 5, 'double gaussian parameters #2');
[b_(19),errormsg_{19}] = ndi.test.values_within_tolerance(doc_e.fit.double_gaussian_parameters(3), doc_a.fit.double_gaussian_parameters(3), 10, 'double gaussian parameters #3');
[b_(20),errormsg_{20}] = ndi.test.values_within_tolerance(doc_e.fit.double_gaussian_parameters(4), doc_a.fit.double_gaussian_parameters(4), 20, 'double gaussian parameters #4');
[b_(21),errormsg_{21}] = ndi.test.values_within_tolerance(doc_e.fit.double_gaussian_parameters(5), doc_a.fit.double_gaussian_parameters(5), 10, 'double gaussian parameters #1');
