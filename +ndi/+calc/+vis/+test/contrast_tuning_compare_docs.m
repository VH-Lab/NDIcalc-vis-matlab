...
switch(scope),
    case 'standard',
       ...
       tolerance.fit.naka_rushton_RB_saturation_index = 0.2;
       tolerance.fit.naka_rushton_RB_sensitivity = 0.2;
    ...
    case 'low_noise',
       ...
       tolerance.fit.naka_rushton_RB_empirical_c50 = 0.1;
       tolerance.fit.naka_rushton_RB_r2 = 0.1;
       tolerance.fit.naka_rushton_RB_relative_max_gain = 0.1;
       tolerance.fit.naka_rushton_RB_saturation_index = 0.1;
       tolerance.fit.naka_rushton_RB_sensitivity = 0.1;
       tolerance.fit.naka_rushton_RBN_parameters = 0.1;
       tolerance.fit.naka_rushton_RBN_contrast = 0.1;
       tolerance.fit.naka_rushton_RBN_values = 0.1;
       tolerance.fit.naka_rushton_RBN_pref = 0.1;
