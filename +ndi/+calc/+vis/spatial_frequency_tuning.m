classdef spatial_frequency_tuning < ndi.calc.tuning_fit
    ...
    methods
        ...
        function [param_struct, independent_variable, x, r] = generate_mock_parameters(spatial_freq_calc_obj, scope, index)
            ...
            %
                ...
                switch function_choice
                    case 'dog'
                        r = vlt.math.dog(spatial_freq_values,P);
                    case 'movshon' %function_params should have 4 values
                        r = vis.frequency.movshon2005_func(spatial_freq_values,P);
