...
I = find(bigtable.best_sf_visual_response_anova_p<0.05);
bigtable_sf = bigtable(I,:);

Y_values = {[prefix '_sf_empirical_low_pass_index'],...
	[prefix '_sf_ultimate_Pref'],...
	[prefix '_sf_fitless_bandwidth'],...
	[prefix '_sf_empirical_high_pass_index'],...
	[prefix '_sf_empirical_max_response_value']};
Y_labels = {'SF low pass index','SF Pref (Hz)','SF Bandwidth',...
	'SF high pass index','SF Max Response'};
