...
Y_values = { [prefix '_tf_TF_tuning.fit_movshon.Pref'],...
        ...
        [prefix '_tf_TF_tuning.abs.fit_movshon.L50'],...
        [prefix '_tf_TF_tuning.abs.fit_movshon.H50'],...
        [prefix '_tf_TF_tuning.fit_movshon.L50'],...
        [prefix '_tf_TF_tuning.fit_movshon.H50'],...        
        };
Y_labels = {'TF Mov Pref (Hz)', 'TF low pass index','TF high pass index', 'TF MV Bandwidth',...
        'TF MV Abs Bandwidth', 'TF MV Abs L50', 'TF MV Abs H50', 'TF MV L50', 'TF MV H50'};

log_type =  [1 0 0 0 0 1 1 1 1];
plot_type = [1 1 1 2 2 1 1 1 1];
stat_type = [1 1 1 2 2 1 1 1 1];
...
[stats.lme,stats.lme_]=vlt.stats.plot_lme_array(bigtable_tf, condition_name, Y_values, Y_labels, ...
	{'Y','Y','Y','vlt.math.clip(Y,[0 8])','vlt.math.clip(Y,[0 8])' 'Y', 'Y', 'Y', 'Y'}, reference_group, group_name, log_type, plot_type, stat_type,...
